...
// ✅ Add to Cart
const addToCart = async (itemId, size = "") => {  // size optional
  ...
  // ✅ Always save cartItems to localStorage when it changes
  useEffect(() => {
  ...
  const value = {
    ...
    cartItems,
    addToCart,
    removeFromCart,   // ✅ Added removeFromCart here
    setCartItems,
    getCartCount,
    updateQuantity,
    getCartAmount,
