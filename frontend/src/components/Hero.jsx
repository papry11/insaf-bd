...
const Hero = () => {
  return (
    <div className="rounded-2xl flex flex-col lg:flex-row items-center justify-center bg-[#dbe4e5] text-white px-4 sm:px-6 lg:px-12 py-16 relative overflow-hidden">
      <div className="z-10 w-full lg:w-1/2 flex flex-col gap-4 sm:gap-6 items-center text-center">
        ...
        <h1
          className="text-3xl sm:text-4xl lg:text-6xl font-extrabold 
               ...
               bg-gradient-to-r from-[#c9a0c7] via-[#9B5DE5] to-[#F15BB5] 
               text-transparent bg-clip-text drop-shadow-lg animate-fade-in"
        >
          Welcome To INSAAF BD
        </h1>
        ...
        <div>
          <Link
            to="/collection"
            className="bg-[#b47ab1] px-6 py-2 rounded text-white 
